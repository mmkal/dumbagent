...
- Requesting a **Session brief** first refreshes the provider snapshot, then reuses a matching completed brief or creates a new sidecar/forked provider session for the current fork point.
